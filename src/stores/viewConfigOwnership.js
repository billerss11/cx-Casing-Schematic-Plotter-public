...
const VIEW_CONFIG_OWNERSHIP_MAP = Object.freeze({
    ...
    topologyUseOpenHoleSource: VIEW_CONFIG_OWNERSHIP_BUCKETS.WELL_LEVEL,
    smartLabelsEnabled: VIEW_CONFIG_OWNERSHIP_BUCKETS.WELL_LEVEL,
    xExaggeration: VIEW_CONFIG_OWNERSHIP_BUCKETS.WELL_LEVEL,
    verticalLabelScale: VIEW_CONFIG_OWNERSHIP_BUCKETS.WELL_LEVEL,
    directionalLabelScale: VIEW_CONFIG_OWNERSHIP_BUCKETS.WELL_LEVEL,
